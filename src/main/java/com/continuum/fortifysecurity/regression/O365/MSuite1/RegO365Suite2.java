...
public class RegO365Suite2 {
	...
	public void tc001RegO365Suite2(String browser) throws Exception {
		final WebDriver driver = WebDriverFactory.get(browser);
		// Loading the test data from excel using the test case id
		HashMap<String, String> testData = PortalUtils.getTestData("C11247655", RegO365Suite2.class.getName(), driver);
	...
	public void tc002RegO365Suite2(String browser) throws Exception {
		final WebDriver driver = WebDriverFactory.get(browser);
		// Loading the test data from excel using the test case id
		HashMap<String, String> testData = PortalUtils.getTestData("C11247656", RegO365Suite2.class.getName(), driver);
		browser = testData.get("BROWSER_NAME").toString();
		String itsLoginID = testData.get("ITS_USERNAME").toString();
		String itsPassword = testData.get("ITS_PASSWORD").toString();
		String siteName = testData.get("SITE_NAME").toString();
